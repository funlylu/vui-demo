/*
 * @Author: koko
 * @Date: 2022-03-23 17:13:23
 * @FilePath: \san-player\scripts\create-comp.js
 * @LastEditTime: 2022-03-24 09:48:29
 * @LastEditors: koko
 * @Description: 是用来生成自定义组件目录和自定义组件说明文档脚本
 */
// 创建自定义组件脚本
...
process.stdin.on("data", async (chunk) => {
  ...
  // 组件名称
  let cssName = String(chunk).trim().toString();
  inputName = uppercamelize(cssName);
  ...
  if (inputName) {
    ...
    try {
      ...
      await generateFile(componentVueName, vueTemplate(componentName,cssName));
